...
public class Sobre extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Projeto de LPOO - 2º período");
        jLabel1.setToolTipText("");

        jLabel2.setText("Engenharia da Computação - POLI");

        jLabel3.setText("Anna Gabriela Carvalho");

        jLabel4.setText("Eduarda Ottoni");
